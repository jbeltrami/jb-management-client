...
/***/ (function(module, exports, __webpack_require__) {
	...
	var clientEvents = __webpack_require__(39);
	var serviceEvents = __webpack_require__(45);
	var signInScreen = __webpack_require__(33);
	var dashboard = __webpack_require__(12);
	var recentServicesTable = __webpack_require__(34);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://jb-management.herokuapp.com',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signUpScreen = __webpack_require__(32);
	var signInScreen = __webpack_require__(33);
	var changePWScreen = __webpack_require__(35);
	var servicesUi = __webpack_require__(36);
	var servicesApi = __webpack_require__(38);
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  api.signIn(data).then(ui.signInSuccess).then(function () {
	    servicesApi.getServiceIndex(data).then(servicesUi.getRecentServicesSuccess).catch(servicesUi.getServiceIndexFailure);
	...
	var toSignUpPage = function toSignUpPage() {
	  event.preventDefault();
	  $('.render-page').empty();
	...
	var toChangePW = function toChangePW() {
	  event.preventDefault();
	  $('.render-page').empty();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "  <div id=\"page-wrapper\">\n    <div class=\"row\">\n      <div class=\"col-lg-12\">\n        <h1 class=\"page-header\">Dashboard</h1>\n      </div>\n      <!-- /.col-lg-12 -->\n    </div>\n    <div class=\"row\"><h5 id=\"temp-message\"></h5></div>\n    <!-- /.row -->\n    <div class=\"row\">\n      <div class=\"col-lg-8\">\n        <!-- /.panel -->\n        <div class=\"panel panel-default\">\n          <div class=\"panel-heading\">\n            <i class=\"fa fa-bar-chart-o fa-fw\"></i> Recent Services\n          </div>\n          <!-- /.panel-heading -->\n          <div class=\"panel-body\">\n            <div class=\"row\">\n              <div class=\"col-lg-12\">\n                <div class=\"table-responsive\">\n                  <table class=\"table table-bordered table-hover table-striped\">\n                    <div class=\"recent-services-table\"></div>\n                  </table>\n                </div>\n                <!-- /.table-responsive -->\n              </div>\n              <!-- /.col-lg-4 (nested) -->\n              <!-- /.col-lg-8 (nested) -->\n            </div>\n            <!-- /.row -->\n          </div>\n          <!-- /.panel-body -->\n        </div>\n        <!-- /.panel -->\n        <!-- /.panel -->\n      </div>\n      <!-- /.col-lg-8 -->\n      <!-- /.col-lg-4 -->\n    </div>\n    <!-- /.row -->\n  </div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"container sign-up-screen\">\n    <div class=\"row\">\n        <div class=\"col-md-4 col-md-offset-4\">\n            <div class=\"login-panel panel panel-default\">\n                <div class=\"panel-heading\">\n                    <h3 class=\"panel-title\">Please Sign Up</h3>\n                </div>\n                <div class=\"panel-body\">\n                    <form id=\"sign-up\">\n                        <fieldset>\n                            <div class=\"form-group\">\n                                <input class=\"form-control\" placeholder=\"E-mail\" name=\"credentials[email]\" type=\"email\" required=\"true\" autofocus>\n                            </div>\n                            <div class=\"form-group\">\n                                <input class=\"form-control\" placeholder=\"Password\" name=\"credentials[password]\" type=\"password\" value=\"\" required=\"true\" autofocus>\n                            </div>\n                            <div class=\"form-group\">\n                                <input class=\"form-control\" placeholder=\"Password confirmation\" name=\"credentials[password_confirmation]\" type=\"password\" value=\"\" required=\"true\" autofocus>\n                            </div>\n                            <!-- Change this to a button or input when using this as a form -->\n                            <input class=\"btn btn-lg btn-success btn-block\" type=\"submit\" name=\"submit\" value=\"Sign up!\">\n                        </fieldset> <br/>\n                    </form>\n                    <button class=\"btn btn-lg btn-success btn-block go-to-signin\">Back to Sign-In</button>\n                </div>\n            </div>\n            <h5 class=\"panel-primary\" id=\"temp-message\"></h5>\n        </div>\n    </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"container login-screen\">\n  <div class=\"row\">\n    <div class=\"col-md-4 col-md-offset-4\">\n      <div class=\"login-panel panel panel-default\">\n        <div class=\"panel-heading\">\n          <h3 class=\"panel-title\">Please Sign In</h3>\n        </div>\n        <div class=\"panel-body\">\n          <form id=\"sign-in\">\n            <fieldset>\n              <div class=\"form-group\">\n                <input class=\"form-control\" placeholder=\"E-mail\" name=\"credentials[email]\" type=\"email\" required=\"true\" autofocus>\n              </div>\n              <div class=\"form-group\">\n                <input class=\"form-control\" placeholder=\"Password\" name=\"credentials[password]\" type=\"password\" value=\"\" required=\"true\" autofocus>\n              </div>\n              <!-- Change this to a button or input when using this as a form -->\n              <input class=\"btn btn-lg btn-success btn-block\" type=\"submit\" name=\"submit\" value=\"Sign in!\">\n            </fieldset> <br/>\n          </form>\n          <button class=\"btn btn-lg btn-success btn-block go-to-signup\">Create an account</button>\n        </div>\n      </div>\n      <h5 class=\"panel-primary\" id=\"temp-message\"></h5>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "   <tr>\n     <td><a href=\"\" data-email=\""
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.client : stack1)) != null ? stack1.email : stack1), depth0))
	    + "\" class=\"individual-services\">"
	    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.client : stack1)) != null ? stack1.email : stack1), depth0))
	    + "</a></td>\n     <td>"
	    ...
	    + "</td>\n     <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.service_date : stack1), depth0))
	    + "</td>\n   </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<table id=\"recent-services-table\" class=\"table\">\n  <thead>\n    <tr>\n      <th>Client's E-mail</th>\n      <th>Service Description</th>\n      <th>Price</th>\n      <th>Date</th>\n    </tr>\n </thead>\n\n <tbody id=\"recent-services-table-body\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.services : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " </tbody>\n\n</table>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"container login-screen\">\n  <div class=\"row\">\n    <div class=\"col-md-4 col-md-offset-4\">\n      <div class=\"login-panel panel panel-default\">\n        <div class=\"panel-heading\">\n          <h3 class=\"panel-title\">Change your password</h3>\n        </div>\n        <div class=\"panel-body\">\n          <form id=\"changepw\">\n            <fieldset>\n              <div class=\"form-group\">\n                <input class=\"form-control\" placeholder=\"old password\" name=\"passwords[old]\" type=\"password\" required=\"true\" autofocus>\n              </div>\n              <div class=\"form-group\">\n                <input class=\"form-control\" placeholder=\"new password\" name=\"passwords[new]\" type=\"password\" required=\"true\" autofocus>\n              </div>\n              <!-- Change this to a button or input when using this as a form -->\n              <input class=\"btn btn-lg btn-success btn-block\" type=\"submit\" name=\"submit\" value=\"Change password\">\n            </fieldset> <br/>\n          </form>\n        </div>\n      </div>\n        <h5 class=\"panel-primary\" id=\"temp-message\"></h5>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showServices = __webpack_require__(37);
	var recentServices = __webpack_require__(34);
	var api = __webpack_require__(38);

	var addServiceSuccess = function addServiceSuccess(data) {
	  // console.log(data)
	};

	var addServiceFailure = function addServiceFailure(data) {
	  // console.log(data)
	};

	var getServiceSuccess = function getServiceSuccess(data) {
	  // console.log(data)
	};

	var getServiceFailure = function getServiceFailure(data) {
	  // console.log(data)
	};

	var getServiceIndexSuccess = function getServiceIndexSuccess(data) {
	  var indexServices = showServices({
	...
	var getServiceIndexFailure = function getServiceIndexFailure(data) {
	  // console.log(data)
	};

	var updateServiceSuccess = function updateServiceSuccess(data) {
	  // console.log(data)
	};

	var updateServiceFailure = function updateServiceFailure(data) {
	  // console.log(data)
	};
	var destroyServiceSuccess = function destroyServiceSuccess(data) {
	  // console.log(data)
	};

	var destroyServiceFailure = function destroyServiceFailure(data) {
	  // console.log(data)
	};

	var getRecentServicesSuccess = function getRecentServicesSuccess(data) {
	  // const sortedArray = data.services.sort().slice(0, 4)
	  // console.log('sortedArray is: ', sortedArray)
	  var recentIndexServices = recentServices({
	    services: data.services.sort().slice(0, 4)
	  });
	  $('.recent-services-table').empty();
	  $('.recent-services-table').append(recentIndexServices);
	};
	var getRecentServicesFailure = function getRecentServicesFailure(data) {
	  // console.log(data)
	};

	var toFilteredServiceSuccess = function toFilteredServiceSuccess(data) {
	  var indexServices = showServices({
	    services: data
	  });
	  $('.render-page').empty();
	...
	var toFilteredServiceFailure = function toFilteredServiceFailure(data) {};

	module.exports = {
	  addServiceSuccess: addServiceSuccess,
	  addServiceFailure: addServiceFailure,
	  getServiceSuccess: getServiceSuccess,
	  getServiceFailure: getServiceFailure,
	  getServiceIndexSuccess: getServiceIndexSuccess,
	  getServiceIndexFailure: getServiceIndexFailure,
	  updateServiceSuccess: updateServiceSuccess,
	  updateServiceFailure: updateServiceFailure,
	  destroyServiceSuccess: destroyServiceSuccess,
	  destroyServiceFailure: destroyServiceFailure,
	  getRecentServicesSuccess: getRecentServicesSuccess,
	  getRecentServicesFailure: getRecentServicesFailure,
	  toFilteredServiceSuccess: toFilteredServiceSuccess,
	  toFilteredServiceFailure: toFilteredServiceFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "   <tr>\n     <td><a href=\"\" data-email=\""
	    ...
	    + "\" class=\"btn btn-sm btn-danger destroy-service\">Delete Service</button>\n     </td>\n     <td>\n       <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-sm btn-warning update-service\">Update Service</button>\n     </td>\n   </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<table id=\"services-table\" class=\"table\">\n  <thead>\n    <tr>\n      <th>Client's E-mail</th>\n      <th>Description</th>\n      <th>Price</th>\n      <th>Date</th>\n      <th>Delete Service</th>\n      <th>Update Service</th>\n    </tr>\n </thead>\n\n <tbody id=\"services-table-body\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.services : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " </tbody>\n\n</table>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addService = function addService(data) {
	  return $.ajax({
	...
	var getServiceIndex = function getServiceIndex(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/services/',
	    method: 'GET',
	    headers: {
	...
	var destroyService = function destroyService(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/services/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onAddClient = function onAddClient(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.addClient(data).then(function () {
	    api.getClientIndex(data).then(ui.getClientIndexSuccess).catch(ui.getClientIndexFailure);
	  }).catch(ui.addClientFailure);
	};

	var onGetClient = function onGetClient(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.getClient(data).then(ui.getClientSuccess).catch(ui.getClientFailure);
	};

	var onGetClientIndex = function onGetClientIndex(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.getClientIndex(data).then(ui.getClientIndexSuccess).catch(ui.getClientIndexFailure);
	};

	var onUpdateClient = function onUpdateClient(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.updateClient(data).then(function () {
	    api.getClientIndex(data).then(ui.getClientIndexSuccess).catch(ui.getClientIndexFailure);
	  }).catch(ui.updateClientFailure);
	};

	var toUpdateClient = function toUpdateClient(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.getClient(data).then(ui.toUpdateClientSuccess).catch(ui.toUpdateClientFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addClient = function addClient(data) {
	  return $.ajax({
	...
	var getClientIndex = function getClientIndex(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/clients/',
	    method: 'GET',
	    headers: {
	...
	var updateClient = function updateClient(data) {
	...
	var destroyClient = function destroyClient(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var api = __webpack_require__(40);
	var showClients = __webpack_require__(42);
	var addClient = __webpack_require__(43);
	var updateClient = __webpack_require__(44
	...
	var addClientSuccess = function addClientSuccess(data) {
	  // console.log(data)
	};

	var addClientFailure = function addClientFailure(data) {
	  userMessage('This e-mail is already taken. Please try a different one.');
	};

	var getClientSuccess = function getClientSuccess(data) {
	  // console.log(data)
	};

	var getClientFailure = function getClientFailure(data) {
	  // console.log(data)
	};

	var toAddClient = function toAddClient() {
	  $('.render-page').empty();
	  $('.render-page').append(addClient);
	};

	var getClientIndexSuccess = function getClientIndexSuccess(data) {
	  // console.log(data.clients)
	  var indexClients = showClients({
	...
	var getClientIndexFailure = function getClientIndexFailure(data) {
	  // console.log(data)
	};

	var updateClientSuccess = function updateClientSuccess(data) {
	  // console.log(data)
	};

	var updateClientFailure = function updateClientFailure(data) {
	  // console.log(data)
	};

	var destroyClientSuccess = function destroyClientSuccess(data) {
	  // console.log(data)
	};

	var destroyClientFailure = function destroyClientFailure(data) {
	  // console.log(data)
	};

	var toUpdateClientSuccess = function toUpdateClientSuccess(data) {
	...
	module.exports = {
	  ...
	  addClientFailure: addClientFailure,
	  getClientSuccess: getClientSuccess,
	  getClientFailure: getClientFailure,
	  getClientIndexSuccess: getClientIndexSuccess,
	  getClientIndexFailure: getClientIndexFailure,
	  updateClientSuccess: updateClientSuccess,
	  updateClientFailure: updateClientFailure,
	  destroyClientSuccess: destroyClientSuccess,
	  destroyClientFailure: destroyClientFailure,
	  toUpdateClientSuccess: toUpdateClientSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "   <tr>\n     <td><a href=\"\" data-email=\""
	    ...
	    + "</td>\n     <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.family_name : stack1), depth0))
	    + "</td>\n     <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.born_on : stack1), depth0))
	    + "</td>\n     <td>\n       <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-sm btn-danger destroy-client\">Delete Client</button>\n     </td>\n     <td>\n       <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-sm btn-warning update-client\">Update Client</button>\n     </td>\n     <td>\n       <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-sm btn-success add-service\">Add Service</button>\n     </td>\n   </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"search-bar\">\n  <input type=\"text\" name=\"search\" value=\"\" autocomplete=\"off\" id=\"search-client\" placeholder=\"Search\">\n</div>\n\n<table id=\"clients-table\" class=\"table\">\n  <thead>\n    <tr>\n      <th>E-mail</th>\n      <th>First Name</th>\n      <th>Last Name</th>\n      <th>Date of Birth</th>\n      <th>Delete Client</th>\n      <th>Update Client</th>\n      <th>Add Service</th>\n    </tr>\n </thead>\n\n <tbody id=\"clients-table-body\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.clients : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " </tbody>\n\n</table>\n\n<button class=\"btn btn-sm btn-default add-client\">Add client</button>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"add-client\">\n  <legend>Add client</legend>\n  <span>Family Name</span><input class=\"form-control\" name=\"client[family_name]\" type=\"text\" required=\"true\" placeholder=\"Family Name\" autofocus>\n  <span>First Name</span><input class=\"form-control\" name=\"client[first_name]\" type=\"text\" required=\"true\" placeholder=\"First Name\" autofocus>\n  <span>DOB</span><input class=\"form-control\" name=\"client[born_on]\" type=\"date\" required=\"true\" placeholder=\"DOB yyyy/mm/dd\" autofocus>\n  <span>Email</span><input class=\"form-control\" name=\"client[email]\" type=\"email\" required=\"true\" placeholder=\"email\" autofocus>\n  <input class=\"btn btn-md btn-success btn-block\" type=\"submit\" name=\"submit\" value=\"Add client!\">\n</form>\n\n<div class=\"row\">\n  <h5 id=\"temp-message\"></h5>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"update-client\">\n  <legend>Update client</legend>\n  <input class=\"form-control clientId\"name=\"client[id]\" type=\"text\" placeholder=\"Client ID\" required=\"true\">\n  <span>First Name</span><input class=\"form-control first_name\"name=\"client[first_name]\" type=\"text\" placeholder=\"First Name\" required=\"true\" autofocus>\n  <span>Last Name</span><input class=\"form-control family_name\"name=\"client[family_name]\" type=\"text\" placeholder=\"Family Name\" required=\"true\" autofocus>\n  <span>DOB</span><input class=\"form-control born_on\"name=\"client[born_on]\" type=\"date\" placeholder=\"DOB yyyy/mm/dd\" required=\"true\" autofocus>\n  <span>E-mail</span><input class=\"form-control email\"name=\"client[email]\" type=\"email\" placeholder=\"email\" required=\"true\" autofocus>\n\n  <input class=\"btn btn-md btn-success btn-block\" type=\"submit\" name=\"submit\" value=\"Update client!\">\n</form>\n\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addService = __webpack_require__(46);
	var updateService = __webpack_require__(47);

	var onAddService = function onAddService(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.addService(data).then(function () {
	    api.getServiceIndex(data).then(ui.getServiceIndexSuccess).catch(ui.getServiceIndexFailure);
	  }).catch(ui.addServiceFailure);
	};

	var onGetService = function onGetService(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.getService(data).then(ui.getServiceSuccess).catch(ui.getServiceFailure);
	};

	var onGetServiceIndex = function onGetServiceIndex(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.getServiceIndex(data).then(ui.getServiceIndexSuccess).catch(ui.getServiceIndexFailure);
	};

	var onUpdateService = function onUpdateService(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.updateService(data).then(function () {
	    api.getServiceIndex(data).then(ui.getServiceIndexSuccess).catch(ui.getServiceIndexFailure);
	  }).catch(ui.updateServiceFailure);
	};

	var toAddService = function toAddService() {
	  $('.render-page').empty();
	...
	var toUpdateService = function toUpdateService() {
	  $('.render-page').empty();
	  $('.render-page').append(updateService
	  // $('.serviceId').val(event.target.dataset.id)
	  // $('.serviceId').css('display', 'none')
	  );api.getService(event.target.dataset.id).then(function (value) {
	...
	var toFilteredService = function toFilteredService(event) {
	  var data = event.target.dataset.email;
	  event.preventDefault();
	  api.getServiceIndex().then(function (value) {
	    return value.services.filter(function (e) {
	      return e.client.email === data;
	    });
	  }).then(ui.toFilteredServiceSuccess).catch(ui.toFilteredServiceFailure);
	};

	var onGetRecentServices = function onGetRecentServices() {
	  event.preventDefault();
	  api.getServiceIndex().then(ui.getRecentServicesSuccess).catch(ui.getRecentServicesFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"add-service\">\n  <legend>Add service</legend>\n  <input class=\"form-control clientId\"name=\"service[client_id]\" type=\"text\" required=\"true\" placeholder=\"Client ID\">\n  <span>Service description</span><textarea class=\"form-control\" name=\"service[description]\" type=\"text\" required=\"true\" placeholder=\"Service description\" rows='7' autofocus></textarea>\n  <span>Service date</span><input class=\"form-control\"name=\"service[service_date]\" type=\"date\" required=\"true\" placeholder=\"Date of the service\" autofocus>\n  <span>Price</span><input class=\"form-control\"name=\"service[price]\" type=\"number\" step='0.10' required=\"true\" placeholder=\"Service Price\" autofocus>\n  <input class=\"btn btn-md btn-success btn-block\" type=\"submit\" name=\"submit\" value=\"Add service!\">\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"update-service\">\n  <legend>Update service</legend>\n  <input class='form-control serviceId' name=\"service[id]\" type=\"text\" placeholder=\"Service ID\" required=\"true\">\n  <input class='form-control clientId' name=\"service[client_id]\" type=\"text\" placeholder=\"Change client - provide the ID\" required=\"true\">\n  <span>Service description</span><textarea class=\"form-control service_description\" name=\"service[description]\" type=\"text\" placeholder=\"Service description\" rows='7' required=\"true\" autofocus></textarea>\n  <span>Service date</span><input class='form-control service_date' name=\"service[service_date]\" type=\"date\" placeholder=\"Date of the service\" required=\"true\" autofocus>\n  <span>Price</span><input class='form-control price' name=\"service[price]\" type=\"number\" step='0.10' placeholder=\"Service Price\" required=\"true\" autofocus>\n  <input class=\"btn btn-md btn-success btn-block\" type=\"submit\" name=\"submit\" value=\"Update service!\">\n</form>\n";
	},"useData":true});
